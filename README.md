...
This repository contains the official implementation for the paper [_Neural Graph Map: Dense Mapping with Efficient Loop Closure Integration_](https://kth-rpl.github.io/neural_graph_mapping/) by Leonard Bruns, Jun Zhang, and Patric Jensfelt. By anchoring neural fields to the pose graph of a sparse visual SLAM system, we can do dense neural mapping while supporting large-scale loop closures (i.e., map deformation) without requiring full reintegration.
...
If you compare with our method or find this code useful in your research, consider citing our paper:
